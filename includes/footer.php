<footer>
    <div class="footer-content">
        ...
        <div class="footer-section footer-right">
            ...
            <ul class="liststyle_none mapa-sitio">
                <li><a href="index.php"><i class="fa-duotone fa-solid fa-house"></i>Inicio</a></li>
                ...
                <li><a href="contacto.php"><i class="fa-duotone fa-solid fa-phone"></i>Contáctanos</a></li>
            </ul>
            </div>
        </div>
    </div>
