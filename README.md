...
NuevoPack: Digitalización y E-commerce para una Imprenta

Descripción del Proyecto
La plataforma de e-commerce NuevoPack se creó con el objetivo de digitalizar las operaciones de imprenta NuevoPack. El objetivo principal es crear una página web donde los clientes puedan acceder a un catálogo de productos personalizados, realizar pedidos en línea y administrar de manera segura sus pagos. Además, se incluye una aplicación móvil que permite al personal administrativo administrar de manera eficiente los pedidos, los inventarios y los datos de los clientes.
